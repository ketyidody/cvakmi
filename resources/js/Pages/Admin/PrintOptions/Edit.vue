...
const form = useForm({
    name: props.printOption.name,
    description: props.printOption.description ?? '',
    price: props.printOption.price,
    display_order: props.printOption.display_order,
    is_active: props.printOption.is_active,
});

const submit = () => form.put(route('admin.print-options.update', props.printOption.id));
</script>

<template>
    <Head title="Edit Print Option" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Print Option</h2>
