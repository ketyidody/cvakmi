    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                ...
                <Link :href="route('admin.services.index')" class="text-gray-600 hover:text-gray-900">
                    Back to Services
                </Link>
            </div>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submit" class="p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Leave empty if price varies</p>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <Link :href="route('admin.services.index')" class="text-sm text-gray-600 hover:text-gray-900">
                                Cancel
                            </Link>
