...
const submit = () => {
    form.post(route('admin.pricing-types.store'));
};
</script>

<template>
    <Head title="Create Pricing Type" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Pricing Type</h2>
