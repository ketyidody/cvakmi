...
const form = useForm({
    ...
    full_name: props.review.full_name,
    review_date: props.review.review_date,
    source: props.review.source,
    content: props.review.content,
    rating: props.review.rating,
    display_order: props.review.display_order,
    is_active: props.review.is_active,
    _method: 'PUT',
});

const submit = () => {
    form.post(route('admin.reviews.update', props.review.id), {
        forceFormData: true,
    });
};
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Review: {{ review.full_name }}</h2>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form @submit.prevent="submit" class="p-6">
                        <div class="mb-4">
                            ...
                            <div v-if="review.thumbnail_image" class="mb-2">
                                <img :src="`/storage/${review.thumbnail_image}`" :alt="review.full_name" class="h-32 w-32 rounded-full object-cover">
