...
const form = useForm({
    ...
    display_order: props.classroom.display_order,
    is_active: props.classroom.is_active,
});

const submit = () => form.put(route('admin.classrooms.update', props.classroom.slug));
</script>
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Classroom</h2>
