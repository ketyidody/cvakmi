...
const form = useForm({
    pricing_type_id: props.pricingPackage.pricing_type_id,
    name: props.pricingPackage.name,
    description: props.pricingPackage.description,
    price: props.pricingPackage.price,
    duration: props.pricingPackage.duration,
    display_order: props.pricingPackage.display_order,
    is_featured: props.pricingPackage.is_featured,
    is_active: props.pricingPackage.is_active,
    services: props.pricingPackage.services?.map(s => ({
        id: s.id,
...
const submit = () => {
    form.post(route('admin.pricing-packages.update', props.pricingPackage.id));
};
</script>

<template>
    <Head title="Edit Pricing Package" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Pricing Package: {{ pricingPackage.name }}</h2>
