...
const props = defineProps({
    package: Object,
    printOptions: Array,
    // Map of print_option_id => included_quantity for the package being edited.
    allowances: Object,
});
...
const form = useForm({
    ...
    display_order: props.package.display_order,
    is_active: props.package.is_active,
    allowances: Object.entries(props.allowances ?? {}).map(([print_option_id, included_quantity]) => ({
        print_option_id: Number(print_option_id),
        included_quantity,
    })),
});
...
const submit = () => form.put(route('admin.packages.update', props.package.id));
</script>
                    ...
                    <form @submit.prevent="submit" class="p-6">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-xs text-gray-500 mb-2">
                                How many photos of each format the package covers.
                            </p>
