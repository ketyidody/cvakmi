...
<!--                    </Link>-->
        ...
        <!-- Footer -->
        <footer class="mt-32 mb-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto">
                <div class="border-t border-gray-200 pt-8">
                    <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                        <p class="text-sm text-gray-500 font-light">
                            &copy; {{ new Date().getFullYear() }} CVAKMI.SK • Všetky práva vyhradené
                        </p>
                        <div class="flex space-x-6">
                            <a href="https://www.instagram.com/cvakmi/" class="text-gray-400 hover:text-gray-900 transition-colors" aria-label="Instagram">
                            ...
                            <a href="https://www.facebook.com/cvakmi.sk" class="text-gray-400 hover:text-gray-900 transition-colors" aria-label="Facebook">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
